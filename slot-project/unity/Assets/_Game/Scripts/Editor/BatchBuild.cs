...
namespace Game.EditorTools
{
    ...
    public static class BatchBuild
    {
        public static void BuildFromCommandLine()
        {
            ...
            if (!SceneSetup.HasEnabledScene()) SceneSetup.CreateMainScene();
        ...
        {
            var name = string.IsNullOrEmpty(PlayerSettings.productName) ? "NeonFortune" : PlayerSettings.productName;
            switch (target)
            {
